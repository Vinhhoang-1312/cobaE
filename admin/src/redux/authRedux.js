import { publicRequest, accountRequest } from "../requestMethods";
import { signinSuccess, signinStart, signinFailure } from "./accountRedux";
import {
...
// LOGIN
async function signinRequest(dispatch, account) {
  dispatch(signinStart());
  try {
    const response = await publicRequest.post("auth/login", account);
...
async function deleteProduct(id, dispatch) {
  ...
  try {
    const response = await accountRequest.delete(`products/${id}`);
...
async function updateProduct(id, product, dispatch) {
  ...
  try {
    const response = await accountRequest.patch(`/products/${id}`, product);
...
async function addProduct(product, dispatch) {
  ...
  try {
    const response = await accountRequest.post(`/products`, product);
...
async function getOrders(dispatch) {
  ...
  try {
    const response = await accountRequest.get("orders");
...
async function deleteOrder(id, dispatch) {
  ...
  try {
    const response = await accountRequest.delete(`orders/${id}`);
...
async function updateOrder(id, order, dispatch) {
  ...
  try {
    const response = await accountRequest.patch(`/orders/${id}`, order);
...
async function getMembers(dispatch) {
  ...
  try {
    const response = await publicRequest.get("accounts");
...
async function deleteMember(id, dispatch) {
  ...
  try {
    const response = await accountRequest.delete(`accounts/${id}`);
...
async function updateMember(id, member, dispatch) {
  ...
  try {
    const response = await accountRequest.patch(`/accounts/${id}`, member);
...
async function addMember(admin, dispatch) {
  ...
  try {
    const response = await accountRequest.post(`/auth/register`, admin);
