  ...
  return (
    <Container>
      ...
      <Wrapper>
        ...
        <OrderContainer>
          <ProductContainer>
            <Subtitle>Ordered Product</Subtitle>
            <TextContainer>
              <Left>
                <Text>Product</Text>
              </Left>
            ...
            {products?.map((i) => (
              <Item
                key={
                  i.productId._id + i.productId.category + i.productId.country
                }
              >
                <Info>
                  <Product>
                    <Left>
                      <Details>
                        ...
                        >
                          <Image src={i.productId.image} />
                        </ProductImage>
                        <ProductDetails>
                          <ProductName>{i.productId.name}</ProductName>
                          <ProductInfo>{i.productId.decription}</ProductInfo>
                          <ProductInfo> {i.productId.category} US</ProductInfo>
                          <ProductInfo> {i.productId.country} US</ProductInfo>
