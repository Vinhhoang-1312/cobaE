...
const Product = () => {
  ...
  useEffect(() => {
    const getStats = async () => {
      try {
        const res = await accountRequest.get("orders/income?pid=" + productId);
          ...
          <Right>
            ...
            <ProductContainer>
              ...
              <ProductDetails>
                ...
                <ProductInfo>
                  <ProductKey>country:</ProductKey>
                  <ProductValue>{product.country}</ProductValue>
                </ProductInfo>
                <ProductInfo>
                ...
                <ProductInfo>
                  <ProductKey>quantity/s:</ProductKey>
                  <ProductValue>{product.quantity}</ProductValue>
                </ProductInfo>
              </ProductDetails>
            </ProductContainer>
          </Right>
